...
export default function App() {
    ...
    }, [globalTimeRange, updateFilteredData, setGlobalTimeRange]);
    ...
    // Note: handleExpandAll and sentry/hubspotProps are no longer used by the new LiveData page,
    // but are kept for potential use by other components or future development.
                    ...
                    <ToggleButtonGroup
                        ...
                        onChange={(event, newTimeRange) => {
                            if (newTimeRange !== null) {
                                handleGlobalTimeRangeChange(newTimeRange);
                            }
                        }}
